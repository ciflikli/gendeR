...
#################
## SYSTEM REQUIREMENTS
## This script was developed and run under R64.app operating under and OS10.12.5.
## R version: R 3.4.0
#################
...
logit.g <- glm(Female~Type+Importance+Year+Level+Convener+Senior+Cluster+Core+Top+Top.Press,
               data=gender,family="binomial")
summary(logit.g)
```
```{r}
...
figure() %>%
  ly_points(Year,AutF,data=gender[gender$Year>1965,], color = ramp, size = Weighted,
            hover=c(Year,AutF))
```